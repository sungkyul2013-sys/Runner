...
export type ToWorker =
  ...
  // The same car, damage and all, into another run: upright on `pose`, no collision node below `floorY` (core
  // World::relaunchVehicle); its broken-off parts are retired.
  | { type: 'relaunch'; vehicle: number; pose: VehiclePose; floorY: number };
